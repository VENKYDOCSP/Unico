...
<div class="position-relative container-fluid p-0 m-0 " id="banner" id="top">
    ...
    <div class=" d-md-none d-block">
        <div class="m-0 p-0 ">
            <img src="https://unicowebsite.s3.ap-south-1.amazonaws.com/HomeBannerForUnicoMobile.jpg" alt="banner"
                class="img-fluid w-100">
        </div>
    </div>
    <div class=" mx-auto mt-md-0 d-flex flex-column justify-content-center align-items-center pb-3   formDetails"
        ...
        <form class="unicoForm  px-md-4 py-md-5 " action="formdb.php" method="post" autocomplete="off">
            <div class="mb-4 borderForInput m">
                <input class="form-control border-0" type="text" placeholder="Full Name" name="name"
                    aria-label="default input example" required oninput="validateText(event)">
            </div>
            <div class="mb-4 borderForInput">
                <input type="tel" class="form-control border-0" id="floatingInput" name="number"
                    placeholder="Phone Number" required oninput="validateNumber(event)">
            </div>
            <div class="mb-4 borderForInput">
                <input type="email" class="form-control border-0" id="floatingInput" name="email" placeholder="Email ID"
                    required>
            </div>
            <div class="mb-4 borderForInput">
                <input type="tel" class="form-control border-0" id="floatingInput" name="pincode" placeholder="Pincode"
                    required oninput="validatePincode(event)">
            </div>
            <div class="mb-4 borderForInput">
                <select class="form-select  floatingInput border-0" aria-label="Default select example" name="product"
                    required>
                    <option selected class="">Select Your Loan</option>
                    <option value="New Flat/ Independent House Purchase Loan">New Flat/ Independent House - Purchase
                        Loan</option>
                    <option value="New Commercial Property- Purchase Loan">New Commercial Property - Purchase Loan
                    </option>
                    ...
                    <option value="Flat/Independent House- Resale Purchase Loan">Flat/ Independent House - Resale
                        Purchase Loan </option>
                    <option value="Resale Commercial Property- Purchase Loan">Resale Commercial Property - Purchase Loan
                    </option>
                    ...
                    <option value="Loan Against Property-Balance Transfer">Loan Against Property - Balance Transfer
                    </option>
            ...
            <div class="row services mx-4  ">
                <div class="servbox m-md-4 " data-aos="zoom-in" data-aos-duration="600">
                    <p class="d-flex justify-content-center ">
                        <img class="img-fluid pt-md-5" width="40%"
                            src="https://unicowebsite.s3.ap-south-1.amazonaws.com/service1.svg" alt="">
                    </p>
                ...
                <div class="servbox m-md-4   " data-aos="zoom-in" data-aos-duration="800">
                    <p class="d-flex justify-content-center ">
                        <img class="img-fluid pt-md-5" width="40%"
                            src="https://unicowebsite.s3.ap-south-1.amazonaws.com/service3.svg" alt="">
                    </p>
                ...
                <div class="servbox m-md-4 " data-aos="zoom-in" data-aos-duration="1000">
                    <p class="d-flex justify-content-center ">
                        <img class="img-fluid pt-md-5" width="40%"
                            src="https://unicowebsite.s3.ap-south-1.amazonaws.com/service4.svg" alt="">
                    </p>
                ...
                <div class="servbox m-md-4 " data-aos="zoom-in" data-aos-duration="1200">
                    <p class="d-flex justify-content-center ">
                        <img class="img-fluid pt-md-5" width="40%"
                            src="https://unicowebsite.s3.ap-south-1.amazonaws.com/service5.svg" alt="">
                    </p>
                ...
                <div class="servbox m-md-4 " data-aos="zoom-in" data-aos-duration="1400">
                    <p class="d-flex justify-content-center ">
                        <img class="img-fluid pt-md-5" width="40%"
                            src="https://unicowebsite.s3.ap-south-1.amazonaws.com/service6.svg" alt="">
                    </p>
                ...
                <div class="servbox m-md-4 " data-aos="zoom-in" data-aos-duration="1600">
                    <p class="d-flex justify-content-center ">
                        <img class="img-fluid pt-md-5" width="40%"
                            src="https://unicowebsite.s3.ap-south-1.amazonaws.com/service7.svg" alt="">
                    </p>
                ...
                <div class="servbox m-md-4 " data-aos="zoom-in" data-aos-duration="1800">
                    <p class="d-flex justify-content-center ">
                        <img class="img-fluid pt-md-5" width="40%"
                            src="https://unicowebsite.s3.ap-south-1.amazonaws.com/service8.svg" alt="">
                    </p>
                ...
                <div class="servbox m-md-4 ">
                    <p class="d-flex justify-content-center ">
                        <img class="img-fluid pt-md-5" width="40%"
                            src="https://unicowebsite.s3.ap-south-1.amazonaws.com/service9.svg" alt="">
                    </p>
...
<div class="pt-4 " style="background-color: #E7E7E7;">
    <div class="container    justify-content-center pt-5">
        <div class="row    justify-content-center align-items-center ">
            <div class="col-12 col-md-6        "><img class="img-fluid" data-aos="fade-right" data-aos-duration="1000"
                    src="https://unicowebsite.s3.ap-south-1.amazonaws.com/abtpro.png" alt=""></div>
            <div class="col-12 col-md-4    ps-2 my-auto ">
                <p class="topvec">
                    <img class="img-fluid text-start" data-aos="fade-down" data-aos-duration="1000"
                        src="https://unicowebsite.s3.ap-south-1.amazonaws.com/Vector+30+(1).svg" alt="">
                </p>
                <h2 class="sell_product ps-3 mb-md-0 ms-2 " data-aos="fade-left" data-aos-duration="1000">Improve your
                    living space with Home Renovation Loan!</h2>
                <p class=" fw-semibold sellprodes pe-md-5 ps-4 py-md-2 mt-2" data-aos="fade-left"
                    data-aos-duration="1000">Enhance your living experience while adding equity to your property,
                    creating a lasting return on your investment. </p>
                <div class=" ps-md-2 ">
                    <a href="#banner"> <button class=" ms-md-3   fs-5 sellbtn" data-aos="fade-left"
                            data-aos-duration="1000">Apply for loan</button></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item acc_itm">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button acc_btn fs-5 " type="button" data-bs-toggle="collapse"
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    <p>Your Home Loan eligibility is decided based on your repayment capacity and up to
                                        90% of the property value. Your repayment capacity depends on income of all
                                        applicants, Age of the primary applicant.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item acc_itm my-3">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes, you can also avail of a loan for Purchase of a home, Construction of a home,
                                    Home repairs, Home improvements, Home extension, Plot purchase + home construction.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item acc_itm">
                    ...
                    <div class="accordion" id="accordionExample1">
                        <div class="accordion-item acc_itm">
                            <h2 class="accordion-header" id="headingO">
                                <button class="accordion-button acc_btn fs-5 " type="button" data-bs-toggle="collapse"
                                    data-bs-target="#collapseO" aria-expanded="true" aria-controls="collapseO">
                            ...
                            <div id="collapseO" class="accordion-collapse collapse show" aria-labelledby="headingO"
                                ...
                                <div class="accordion-body">
                                    <p>The tenure of your home loan ranges for up to 30 years. The term, however, does
                                        not extend beyond the retirement age or 60 years, whichever is earlier.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item acc_itm my-3">
                            ...
                            <div id="collapseT" class="accordion-collapse collapse" aria-labelledby="headingT"
                                ...
                                <div class="accordion-body">
                                    ...
                                    Identified) Sanction Letter for your home loan. You can identify the property you
                                    need to buy based on this document. Kindly speak to your sales manager to know more.
                                </div>
                            </div>
                        </div>
                        <!-- <div class="accordion-item acc_itm">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item acc_itm">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    You can apply for a Home Loan at any time once you have decided to purchase or
                                    construct a property, even if you have not selected the property or the construction
                                    has not commenced. </div>
                            </div>
                        </div>
                        <div class="accordion-item acc_itm my-3">
                            <h2 class="accordion-header" id="headingTwo">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes, resident Indians are eligible for tax benefits on both the principal and the
                                    interest of a home loan under the Income Tax Act. Please consult your tax advisor
                                    for details. </div>
                            </div>
                        </div>
                        <div class="accordion-item acc_itm">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Security of the loan would generally be security interest on the property being
                                    financed by us and / or any other collateral / interim security as may be required
                                    by us. </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion" id="accordionExample1">
                        <div class="accordion-item acc_itm">
                            ...
                            <div id="collapseO" class="accordion-collapse collapse show" aria-labelledby="headingO"
                                data-bs-parent="#accordionExample1">
                                <div class="accordion-body">
                                    <p> Repayment of the principal commences from the month following the month in which
                                        you avail full disbursement of your loan. Pending final disbursement, you pay
                                        interest on the portion of the loan disbursed
                                </div>
                                </p>
                            </div>
                        </div>
                        <div class="accordion-item acc_itm my-3">
                            ...
                            <div id="collapseT" class="accordion-collapse collapse" aria-labelledby="headingT"
                                ...
                                <div class="accordion-body fw-normal">
                                    Encumbrance on a property refers to claims or charges on the property due to
                                    liabilities such as unpaid loans and bills </div>
                            </div>
                        </div>
                        <div class="accordion-item acc_itm">
                            <h2 class="accordion-header" id="headingTh">
                            ...
                            <div id="collapseTh" class="accordion-collapse collapse" aria-labelledby="headingTh"
                                data-bs-parent="#accordionExample1">
                                <div class="accordion-body">
                                    You are required to pay 10-25% of the total property cost as ‘own contribution
                                    depending upon the loan amount. 75 to 90% of the property cost is what can be
                                    availed as a housing loan. </div>
                            </div>
                        </div>
                    </div>
                </div>
