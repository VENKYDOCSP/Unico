...
<section>
        ...
        <div class="container ">
            <div class="row d-flex align-items-center justify-content-between">
                <div class="col-12 col-md-6 solutionDream ps-md-4 pe-md-5 " data-aos="fade-up">
                    <h1 class="solutionDream py-md-1 ">Every Solution
                    ...
                    <button class="soloution_knowmore" onclick="toggleMore()" id="myBtn">Read More</button>
                </div>
                <div class="col-12 col-md-6">
                    <img data-aos="zoom-in-right" src="https://unicowebsite.s3.ap-south-1.amazonaws.com/House+2+1+(1).jpg" alt="">
                </div>
            </div>
        </div>
    </div>
    <div class="container  justify-content-center py-md-5 ">
        <div class="  row    justify-content-center align-items-center ">
            ...
            <div class="col-12 col-md-6     my-auto " data-aos="fade-right">
                ...
                <p class="our_prodctabt ps-3 pt-2 mb-md-0 pt-2"><span class="topvec"> </span>
                    <span class=""> Where Family Thrives, Love Flourishes - </span> We Nurture Your Home Finance to Sustain the Warmth!
                </p>
                <p class="our_proddetails ps-3 mb-md-0 ">We're here to ease your worries, and accompany you on the journey towards your dream home. Together, let's turn your aspirations into reality.We're here to ease your worries, and accompany you on the journey towards your dream home. Together, let's turn your aspirations into reality.</p>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-md-6 missionbg p-md-5 " data-aos="zoom-out-right">
                <h2 class="ps-md-5 pt-md-5">OUR MISSON</h2>
            ...
            <div class="col-12 col-md-6 text-center missionimg p-md-5" data-aos="zoom-out-left">
    ...
    <div class="container-fluid">
        <div class="row  ">
            ...
            <div class="col-12 col-md-6 visionbg p-md-5 " data-aos="zoom-out-left">
                <h2 class="ps-md-5 pt-md-5">OUR VISION</h2>
    ...
    <div class="container-fluid pt-md-5">
        <div class="row text-center values" data-aos="zoom-in-down">
            <h2>OUR VALUES</h2>
            <p class="px-md-5 py-md-3 col-8 m-auto">At <span>Unico</span> we embody <span> Sensitivity, Ownership, Agility, Responsibility, and Synergy (SOARS)</span>as the pillars of our value system. Sensitivity shapes our understanding, Ownership fuels accountability, Agility steers us through change, Responsibility anchors our integrity, and Synergy unleashes our collective potential. Together, we soar to new heights!</p>
            <img src="https://unicowebsite.s3.ap-south-1.amazonaws.com/valu.png" alt="">
        </div>
    </div>
    <div class="containersoars pt-md-5 pb-md-5">
        <div class="text-center " data-aos="zoom-in-up">
            ...
            <img src="https://unicowebsite.s3.ap-south-1.amazonaws.com/soars.png" alt="">
        </div>
    </div>
    <div class="text-center pt-md-5 pb-md-5" data-aos="zoom-in-up">
        <img src="https://unicowebsite.s3.ap-south-1.amazonaws.com/bhdlogo.png" alt="">
    </div>
</section>
<script>
    function toggleMore() {
